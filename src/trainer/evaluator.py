...
class Evaluator():
    ...
    def follow_trajectory(
        ...
        actions = np.array([self.env.action_mapping.get(int(action), 0) for action in follower_actions])
        ...
        return follower_trajectory, actions, crash
    ...
    def evaluate(
        ...
        for _ in range(num_trajectories):
            ...
            follower_trajectory, _, crash = self.follow_trajectory(
                leader_trajectory,
                v_ego_init,
                d_ego_init,
                visualize=False,
